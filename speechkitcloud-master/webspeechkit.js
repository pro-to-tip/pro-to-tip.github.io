        ...
        start: function () {
            ...
            this.socket.onmessage = function (e) {
                ...
                if (message.type == 'InitResponse'){
                    ...
                    this.options.onResult(message.data.text, message.data.uttr, message.data.merge, message.data.words, message.data.biometry);
        ...
        _onstart: function () {
            ...
            this.recognizer = new namespace.ya.speechkit.Recognizer(
                namespace.ya.speechkit._extend(this.options,
                {
                    ...
                    onResult: function (text, uttr, merge, words, biometry) {
                                this.proc += merge;
                                this.options.infoCallback({
                                    send_bytes: this.send_bytes,
                                    format: this.options.format,
                                ...
                                this.options.dataCallback(text, uttr, merge, words, biometry);
                            }.bind(this),
